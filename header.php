...
<header>
    <div class="header__area header__transparent">
        <div class="header__bottom header__bottom-border header__sticky" id="header-sticky">
            <div class="container-fluid header-class-padd">
                        ...
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-5 col-8">
                            <div class="logo logo-border">
                                <a href="index.php">
                                    ...
                                    <img class="logo-dark" src="assets/img/logo-footer.png" alt="logo">
                                </a>
                            </div>
                        </div>
                        <div class="col-xxl-8 col-xl-10 col-lg-10 d-none d-lg-block">
                            <div class="main-menu pl-55 main-menu-ff-space  d-flex justify-content-center">
                                <nav id="mobile-menu">
                                    <ul>
                                        ...
                                        <li class="has-dropdown">
                                            ...
                                            <ul class="submenu">
                                                <li><a href="services-details.php">IT Services and Consulting</a></li>
                                                <li><a href="services-details.php">Media and Production</a></li>
                                                <li><a href="services-details.php">Branding and Advertising</a></li>
                                                <li><a href="services-details.php">Graphics and Animation</a></li>
                                                <li><a href="services-details.php">Networking</a></li>
                                            </ul>
                                        </li>
         ...
         <div class="offcanvas__wrapper">
            ...
            <div class="offcanvas__content">
               ...
               <div class="offcanvas__contact">
                  <p class="offcanvas__contact-call"><a href="tel:+966540491013">+966 540491013</a></p>
                  <p class="offcanvas__contact-mail"><a href="mailto:info@abaftsolutions.com">info@abaftsolutions.com</a></p>
               </div>
            </div>
         </div>
      </div>
